...
type EmailValidation struct {
	...
	SmtpValidationDone bool   `json:"smtpValidationDone"`
...
func smtpVerify(email string) (bool, bool) {
	...
	fmt.Println("SMTP verification could not confirm email address validity")
...
func ValidateEmail(email string) EmailValidation {
	...
	smptpVerified, smptpVerificationPossible := smtpVerify(email)

	if smptpVerificationPossible {
		emailValidationResult.SmtpValidationDone = true
	}
	if smptpVerified {
		emailValidationResult.IsSmtpValid = true
	}
